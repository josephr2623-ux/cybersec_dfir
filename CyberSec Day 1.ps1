...
!!!DAPAT 7 UNDER71SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
conf t
 ...
 NO ip route 10.71.0.0 255.255.0.0 200.0.0.71
 ...
 ip route 10.71.0.0 255.255.0.0 10.71.71.4
 NO ip route 10.71.0.0 255.255.0.0 200.0.0.71
 end
...
conf t 
ip routing
ip route 0.0.0.0 0.0.0.0 10.71.71.1
end
...
http://docwiki.cisco.com/wiki/Cisco71IOS71Voice71Troubleshooting71and71Monitoring71--71Tcl71IVR71Troubleshooting
